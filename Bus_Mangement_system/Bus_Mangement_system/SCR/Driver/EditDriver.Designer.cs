namespace Bus_Mangement_system.SCR.Driver
{
    partial class EditDriver
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.grbEditBus.Controls.Add(this.cmbDriver);
            this.grbEditBus.Controls.Add(this.lblSalary);
            this.grbEditBus.Controls.Add(this.txtSalary);
            this.grbEditBus.Controls.Add(this.label5);
            this.grbEditBus.Controls.Add(this.lblAddress);
            this.grbEditBus.Controls.Add(this.lblPhone);
            this.grbEditBus.Controls.Add(this.txtAddress);
            this.grbEditBus.Controls.Add(this.lblName);
            this.grbEditBus.Controls.Add(this.txtPhone);
            this.grbEditBus.Controls.Add(this.btnEditDriver);
            ...
            this.grbEditBus.TabIndex = 39;
            this.grbEditBus.TabStop = false;
            this.grbEditBus.Text = "Edit Driver";
            // 
            // lblSalary
            // 
